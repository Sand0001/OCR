...
if __name__ == '__main__':
	char_set = open('/home/denghailong/text_renderer_v2/data/chars/chn.txt', 'r', encoding='utf-8').readlines()
	...
	checkpoint = ModelCheckpoint(filepath='./models/weights_' + tag + '_densenet-{epoch:02d}-{val_loss:.2f}.h5', monitor='val_loss', save_best_only=False, save_weights_only=True)
