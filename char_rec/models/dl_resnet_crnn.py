...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(filepath='./models/weights_' + tag + '_resnet-{epoch:02d}-{val_loss:.2f}.h5', monitor='val_loss', save_best_only=False, save_weights_only=True)
